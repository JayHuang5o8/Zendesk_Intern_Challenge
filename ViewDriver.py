    ...
    * Type 'quit' to exit\n"
    ...
    def transform(self, ticket: dict):
        ...
        res = "{0:<10}  {1:<10}  {2:<25}  {3:<20}  {4:<20}  {5:<15}\n".format(
            ...
            self.datetime_transform(ticket.get('due_at')), str(ticket.get('assignee_id')))
        return res
    ...
    def display_range_tickets(self, tickets: list, start: int, end: int):
        '''
        Only display 25 tickets in a page
        '''
        res = self.display_header()
    ...
    def display_page_selection(self, cur_page: int, total_page: int):
        '''
        At all tickets displaying section, prompt page operation 
        '''
